...
def ETL(SQL_connect_details,OPR_to_ODS_tables_list_SQL,OPR_to_ODS_tables_list_MySQL,OPR_to_ODS_tables_list_CSV,OPR_to_ODS_tables_list_API,DWH_queries_dict):

    SQL_source_conn = pyodbc.connect(f'DRIVER={SQL_connect_details['DRIVER']};'
                                f'SERVER={SQL_connect_details['SERVER']};'
                                f'DATABASE={SQL_connect_details['DATABASE']};'
                                f'Trusted_Connection={SQL_connect_details['Trusted_Connection']};')
